...
function view(section_id){
    ...
    $.get('http://' + window.location.hostname + '/wt-pars/wp-json/wt-pars-theme/v2/viewresults/' + section_id, function(data, status){
        ...
        var measuresHook = document.getElementById('measuresHook');
        ...
        var mappingHook = document.getElementById('mappingHook');
        
        for (var d in data) {
            var tr = document.createElement('tr');
            mappingHook.appendChild(tr);
